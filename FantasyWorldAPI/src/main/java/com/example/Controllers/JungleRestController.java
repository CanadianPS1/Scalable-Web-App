...
public class JungleRestController{
    ...
    public String create(@RequestBody Jungle jungle){
        switch(Settings.dbStatus){
            ...
            case JPA -> {
                return JungleRestDataJPA.add(jungle);
            }
            case SQL -> {
    ...
    public List<Jungle> getAll(){
        switch(Settings.dbStatus){
            ...
            case JPA -> {
                return JungleRestDataJPA.getAll();
            }
            case SQL -> {
    ...
    public Jungle findById(@PathVariable int id){
        switch(Settings.dbStatus){
            ...
            case JPA -> {
                return JungleRestDataJPA.findById(id);
            }
            case SQL -> {
    ...
    public Jungle updateById(@RequestBody Jungle jungle){
        switch(Settings.dbStatus){
            ...
            case JPA -> {
                return JungleRestDataJPA.update(jungle);
            }
            case SQL -> {
    ...
    public String delete(@PathVariable int id){
        switch(Settings.dbStatus){
            ...
            case JPA -> {
                return JungleRestDataJPA.delete(id);
            }
            case SQL -> {
